...
strains <- c("5965", "5415", "5967")  # FUN30-9MYC, fun30, fun30-K602R-9MYC
MyColors <- JFly_colors[1:length(strains)]

# plot legend -------------------------------------------------------------
Legend_txt <- c(expression(italic("FUN30-9MYC")),
                expression(italic("fun30"*Delta)),
                expression(italic("fun30-K602R-9MYC")))

pdf(file = "tmp.pdf", width=2.05, height=0.85)
...
pdf(file = "tmp.pdf", width=5.8, height=0.45)
par(cex = 1, mar = rep(0, 4))
plot(1, type="n", axes=FALSE, xlab="", ylab="")
