# info --------------------------------------------------------------------
# purpose: plot resection assay qPCR data
# author: Robert Gnuegge (robert.gnuegge@gmail.com)
# created: 05/25/25
# last modified: 05/25/25
...
strains <- c("6073", "6072", "6075", "6074")  # 2mu-SAE2, fun30 2mu-SAE2, 2mu, fun30 2mu
MyColors <- c("black", "gray", JFly_colors[c(4, 2)])

# plot legend -------------------------------------------------------------
Legend_txt <- c(expression("2"*mu*"-"*italic("SAE2")),
                expression("2"*mu),
