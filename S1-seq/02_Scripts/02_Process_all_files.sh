...
do
	...
	BASEDIR="/home/robert/Research/Manuscripts/My_manuscripts/23-09-Chromatin_remodeler_Impact_on_MRX_nicking/Data_Analyses_and_Figures/S1-seq"

	OUTDIR="$BASEDIR"/03_Processed_data/BAM/"$SAMPLE"
	mkdir -p $OUTDIR
	cd $OUTDIR

	bash "$BASEDIR"/02_Scripts/01_Pipeline_from_fastq_to_bam.sh $SAMPLE
