...
LSY5935_0h_S1_seq <- process_S1_seq(GRanges = LSY5935_0h_S1_seq, roi = roi)
LSY5935_1h_S1_seq <- process_S1_seq(GRanges = LSY5935_1h_S1_seq, roi = roi)
LSY5935_2h_S1_seq <- process_S1_seq(GRanges = LSY5935_2h_S1_seq, roi = roi)
LSY5935_4h_S1_seq <- process_S1_seq(GRanges = LSY5935_4h_S1_seq, roi = roi)

load(file = "../../Rep1/S1-seq/03_Processed_data/S1-seq_coverage/LSY5934_S1-seq.RData")
LSY5934_0h_S1_seq <- process_S1_seq(GRanges = LSY5934_0h_S1_seq, roi = roi, negative_score = TRUE)
LSY5934_1h_S1_seq <- process_S1_seq(GRanges = LSY5934_1h_S1_seq, roi = roi, negative_score = TRUE)
LSY5934_2h_S1_seq <- process_S1_seq(GRanges = LSY5934_2h_S1_seq, roi = roi, negative_score = TRUE)
LSY5934_4h_S1_seq <- process_S1_seq(GRanges = LSY5934_4h_S1_seq, roi = roi, negative_score = TRUE)
...
LSY5934_0h_MNase_seq <- process_MNase_seq(GRanges = LSY5934_0h_MNase_seq, roi = roi, negative_score = TRUE)
LSY5934_1h_MNase_seq <- process_MNase_seq(GRanges = LSY5934_1h_MNase_seq, roi = roi, negative_score = TRUE)
LSY5934_2h_MNase_seq <- process_MNase_seq(GRanges = LSY5934_2h_MNase_seq, roi = roi, negative_score = TRUE)
LSY5934_4h_MNase_seq <- process_MNase_seq(GRanges = LSY5934_4h_MNase_seq, roi = roi, negative_score = TRUE)
# make scores negative for plotting below WT data
...
# plotting ----------------------------------------------------------------
plot_dir <- "04_Plots/mre11-nd/S1-seq_and_MNase-seq_Plots"
...
for (n in 1:length(SrfIcs)){
  ...
  all_S1_seq <- c(LSY5935_0h_S1_seq, LSY5935_1h_S1_seq, LSY5935_2h_S1_seq, LSY5935_4h_S1_seq,
                  LSY5934_0h_S1_seq, LSY5934_1h_S1_seq, LSY5934_2h_S1_seq, LSY5934_4h_S1_seq)
  ...
  DT_S1_seq_WT_0h <- DataTrack_fw_rev(GRanges = LSY5935_0h_S1_seq, fw_col = fw_col_1, rev_col = rev_col_1, type = "h", name = "0 h", ylim = ylim_S1_seq)
  DT_S1_seq_WT_1h <- DataTrack_fw_rev(GRanges = LSY5935_1h_S1_seq, fw_col = fw_col_1, rev_col = rev_col_1, type = "h", name = "1 h", ylim = ylim_S1_seq)
  DT_S1_seq_WT_2h <- DataTrack_fw_rev(GRanges = LSY5935_2h_S1_seq, fw_col = fw_col_1, rev_col = rev_col_1, type = "h", name = "2 h", ylim = ylim_S1_seq)
  DT_S1_seq_WT_4h <- DataTrack_fw_rev(GRanges = LSY5935_4h_S1_seq, fw_col = fw_col_1, rev_col = rev_col_1, type = "h", name = "4 h", ylim = ylim_S1_seq)
  
  DT_S1_seq_fun30_0h <- DataTrack_fw_rev(GRanges = LSY5934_0h_S1_seq, fw_col = fw_col_2, rev_col = rev_col_2, type = "h", name = "0 h", ylim = ylim_S1_seq)
  DT_S1_seq_fun30_1h <- DataTrack_fw_rev(GRanges = LSY5934_1h_S1_seq, fw_col = fw_col_2, rev_col = rev_col_2, type = "h", name = "1 h", ylim = ylim_S1_seq)
  DT_S1_seq_fun30_2h <- DataTrack_fw_rev(GRanges = LSY5934_2h_S1_seq, fw_col = fw_col_2, rev_col = rev_col_2, type = "h", name = "2 h", ylim = ylim_S1_seq)
  DT_S1_seq_fun30_4h <- DataTrack_fw_rev(GRanges = LSY5934_4h_S1_seq, fw_col = fw_col_2, rev_col = rev_col_2, type = "h", name = "4 h", ylim = ylim_S1_seq)
