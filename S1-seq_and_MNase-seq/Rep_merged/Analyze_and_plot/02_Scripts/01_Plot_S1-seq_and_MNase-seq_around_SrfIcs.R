...
LSY5415_0h_MNase_seq <- process_MNase_seq(GRanges = LSY5415_0h_MNase_seq, roi = roi, negative_score = TRUE)
LSY5415_1h_MNase_seq <- process_MNase_seq(GRanges = LSY5415_1h_MNase_seq, roi = roi, negative_score = TRUE)
LSY5415_2h_MNase_seq <- process_MNase_seq(GRanges = LSY5415_2h_MNase_seq, roi = roi, negative_score = TRUE)
LSY5415_4h_MNase_seq <- process_MNase_seq(GRanges = LSY5415_4h_MNase_seq, roi = roi, negative_score = TRUE)
# make scores negative for plotting below WT data
