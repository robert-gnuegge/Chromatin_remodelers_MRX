...
BASEDIR="/home/robert/Research/Manuscripts/My_manuscripts/23-09-Chromatin_remodeler_Impact_on_MRX_nicking/Data_Analyses_and_Figures/S1-seq_and_MNase-seq/Rep1/S1-seq"
...
do
	...
	bash "$BASEDIR"/02_Scripts/03_Pipeline_from_fastq_to_bam.sh $SAMPLE
