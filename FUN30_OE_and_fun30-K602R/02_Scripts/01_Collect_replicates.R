...
unique(cut$strain)
to_keep <- c("4518-13B", "5415", "5965", "5953", "5967", "5935", "5934")  # WT, fun30, FUN30-9MYC, pTDH3-FUN30-9MYC, fun30-K602R-9MYC, mre11-H125N, mre11-H125N fun30
cut <- cut[(cut$strain %in% to_keep & cut$primers == "oRG46_oRG47"), ] 
