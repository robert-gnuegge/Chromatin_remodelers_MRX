...
strains <- c("4518-13B", "5415", "5965", "5967", "5953", "5935", "5934")  
# WT, fun30, FUN30-9MYC, fun30-K602R-9MYC, pTDH3-FUN30-9MYC, mre11-H125N, mre11-H125N fun30
...
Legend_txt <- c("WT",
                ...
                expression(italic("P"["TDH3"]*"-FUN30-9MYC")),
                expression(italic("mre11-H125N")),
                expression(italic("mre11-H125N fun30"*Delta)))

idx <- c(1, 6, 7, 3, 5, 2, 4)
pdf(file = "tmp.pdf", width=2.1, height=1.65)
...
Legend_colors <- c(JFly_colors[1], "gray", JFly_colors[8], JFly_colors[c(3,5)], "white", JFly_colors[c(2,4)])

pdf(file = "tmp.pdf", width=6.05, height=0.85)
par(cex = 1, mar = rep(0, 4))
plot(1, type="n", axes=FALSE, xlab="", ylab="")
legend(1, 1, xjust=0.5, yjust=0.5, legend = Legend_txt, col = Legend_colors, pch = 20, ncol = 3)
dev.off()
